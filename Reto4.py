...
def PromedioMayorMenor(diccionarioE: list)->str:
    listaPro=[]
    for x in diccionarioE:
        for key in x:
            listaPro.append(float(x[key].get("Promedio")))
            #print(x[key].get("Promedio"))
    promedio=sum(listaPro)/len(listaPro)
    pal="El promedio de notas de los {nE} estudiantes es: {pr}, la nota más alta es: {Nmayor} y la nota menor es: {Nmenor}".format(nE=len(listaPro),
    pr=promedio,Nmayor=max(listaPro),Nmenor=min(listaPro))
    print(pal)
    #return pal

def PromedioMayorMenor2(diccionarioE: dict)->list:
    listaPro=[]
...
#CrearDiccionarioEstudiante("TLI;Nombre;CC;Teléfono;Promedio%234jj234d2;Santiago Perez;1006614805;30139020352;4.5%fff342345d;Carol Martinez;111234882;3213213214;4.9%fgfg3333d2;Juan Felacio;11124992;3092404231;2.2%dg8288wj3;Alejandra Gonzales;11112342;3002431243;3.2%ee23553mmd;Andrea Garcia;1002341242;3013090222;1.2")
...
#ImprimirLaInfo(lis1)
#ImprimirLaInfo(lis2)
infor=list(map(PromedioMayorMenor2,[lis1,lis2]))
